...
import karusel.mobile.config.EmulationConfig;
...
public class EmulationMobileDriver implements WebDriverProvider {
    ...
    public WebDriver createDriver(Capabilities capabilities) {
        ...
        options.setAppPackage("www.karusel.ru");
        options.setAppActivity("ru.karusel.rn_app.MainActivity");
    ...
    private File getApp() {
        String appUrl = ""; //Здесь может лежать ссылка на приложение
        String appPath = "src/test/resources/apps/www.karusel.ru.apk";
